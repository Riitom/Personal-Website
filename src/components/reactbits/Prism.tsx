...
type PrismProps = {
  height?: number; baseWidth?: number; animationType?: "rotate" | "hover" | "3drotate";
...
const Prism = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Keep the CSS background and all content usable without WebGL.
      return;
    }
    ...
    const fragment = /* glsl */ `
      ...
      vec4 tanh4(vec4 x){
        vec4 e2x = exp(2.0 * min(x, vec4(20.0)));
